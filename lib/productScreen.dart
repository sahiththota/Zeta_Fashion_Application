                      ...
                      child: Column(
                        ...
                        children:  [
                          const Padding(
                            ...
                            child: const Text("Description :", style: TextStyle(fontSize: 18, fontWeight: FontWeight.normal,color: Colors.white),),
                          ),
                          ...
                          Padding(
                            ...
                            child: RichText(text:  const TextSpan(
                                children: <TextSpan>[
                                  const TextSpan(text: "T-Shirt for men Designed by PUMA Fashions INC @ California",
                                    style: TextStyle(
                                        fontSize: 15,
                                        color: Colors.white,
